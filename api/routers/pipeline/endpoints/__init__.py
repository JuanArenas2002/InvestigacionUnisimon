...
from .extract_reconcile import router as extract_reconcile_router
...
router.include_router(extract_reconcile_router, prefix="",         tags=["Pipeline · Extracción + Reconciliación"])
